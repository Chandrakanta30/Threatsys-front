          ...
          <div className="row foundation-container">
            <div className="col-lg-6">
              <div className="foundation-content">
                <h2>
                  IT Gladiator Professional Career
                  <span style={{ color: "#2267cc" }}> Mentorship</span> Program
                </h2>

                <h4 className="h4-cr">
                  Free Career Mentorship to Help You Succeed in the IT Industry
                </h4>

                <p className="description">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde
                  accusamus maxime doloribus error veniam facilis.
                </p>
