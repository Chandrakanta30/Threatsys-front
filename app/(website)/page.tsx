...
export default function Home() {
  ...
  const homepagecontent = async () => {
    try {
      // The skeleton loader will appear the moment this line executes
      const response = await axiosInstance.get("/homepage");
      setAllContents(response.data.articles);
    } catch (error) {
      console.error("Error fetching homepage blogs:", error);
    }
    // The skeleton loader will disappear automatically here
  };
