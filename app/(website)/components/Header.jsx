  ...
  return (
    ...
    <div className="container-fluid nav-dark">
        <div className="nav-top">
            <div>
                <h6>Level Up at the Future Skills Fiesta –<span className="strt">Save up to 20% on Career Combos</span>
                </h6>
            </div>
            <div>
                <a className="av-btn" href="">Avail Now</a>
            </div>
              <div className="dark-theme d-block-res">
...
<label htmlFor="checkbox" className="checkbox-label">
  ...
  <span className="ball"></span>
            ...
            <div className="top-nav-right">
                {/* <!-- <div className="me-4">
                    <img src="images/time-left.png" alt="Time">
                    <h6>Office Hrs: Today 9.00am to 6.00pm</h6>
                </div>
                <div>
                    <img src="images/phone-call.png" alt="Contact">
                    <h6>+917790000770</h6>
                </div> --> */}
                <div id="timer">
  ...
  <span id="seconds">00</span>S
        ...
        <div className="dark-theme d-none-res">
        <input
  type="checkbox"
  className="checkbox"
  id="checkbox"
...
/>
            ...
            <div className="main-mega-menu">
                <form className="nav-search-form d-none d-lg-flex" action="index.html" method="get">
                    <div className="input-container">
                        {/* <!--/ course sec start /--> */}
                        <div className="flex-div ms-3">
                            <svg width="16" height="16" viewBox="0 0 18 18" fill="#1e57ab"
                            ...
                            <div className="dropdown mega-menu-dropdown courses-dropdown">
                                <span className="megamenu-nav-link dropdown-toggle" id="navbarDropdown"
                                    data-toggle="dropdown">
                                    Courses
                                </span>

                                <div className="dropdown-menu mega-menu">
                                    <div className="row m-0 cstm-row-center">
                                        {/* <!--<[col start]>--> */}
                                        <div className="col-3 item menu-sidebar">
                                            <div className="mega-menu-opt-tabs">
                                                <div className="mega-menu-col-heading">find your training</div>
                                                <div className="nav flex-column nav-pills w-100" id="v-pills-tab"
                                                    role="tablist" aria-orientation="vertical">
                                                    <a className="mega-menu-tab-link active"
                                                        id="v-pills-course-vendor-tab" data-toggle="pill"
                                                        href="#v-pills-course-vendor" role="tab"
                                                        aria-controls="v-pills-course-vendor"
                                                        aria-selected="true">Instructor-led Courses</a>
                                                    <a className="mega-menu-tab-link" id="v-pills-domain-expertise-tab"
                                                        data-toggle="pill" href="#v-pills-domain-expertise"
                                                        role="tab" aria-controls="v-pills-domain-expertise"
                                                        aria-selected="false">By
                                                        Domain/Expertise</a>
                                                    <a className="mega-menu-tab-link" id="v-pills-career-oriented-tab"
                                                        data-toggle="pill" href="#v-pills-career-oriented"
                                                        role="tab" aria-controls="v-pills-career-oriented"
                                                        aria-selected="false">
                                                        Career-Oriented Courses
                                                    </a>
                                                    <a className="mega-menu-tab-link" id="v-pills-combo-courses-tab"
                                                        data-toggle="pill" href="#v-pills-combo-courses" role="tab"
                                                        aria-controls="v-pills-combo-courses" aria-selected="false">
                                                        <span className="course-marker">top</span>
                                                        Course Bundles
                                                    </a>
                                                    <a className="mega-menu-tab-link" id="v-pills-new-course-tab"
                                                        data-toggle="pill" href="#v-pills-new-course" role="tab"
                                                        aria-controls="v-pills-new-course" aria-selected="false">
                                                        <span className="course-marker">new</span>
                                                        Courses
                                                    </a>
                                                    {/* <!-- <a className="mega-menu-tab-link" href="">
                                                        <span className="course-marker">free</span>
                                                        Cybersecurity Training
                                                    </a>
                                                    <a className="mega-menu-tab-link" href="">Self-Paced
                                                        Learning</a>
                                                    <a className="mega-menu-tab-link" href="professional-development-training-courses.html">Business
                                                        Leadership Programs</a> --> */}

                                                    {/* <!-- These are just links (no tab attributes) --> */}
                                                    <a className="mega-menu-tab-link"
                                                        href="cyber-security-details-page.html">
                                                        <span className="course-marker">free</span>
                                                        Cybersecurity Training
                                                    </a>
                                                    <a className="mega-menu-tab-link" href="self-paced-learning.html">
                                                        Self-Paced Learning
                                                    </a>
                                                    <a className="mega-menu-tab-link"
                                                        href="professional-development-training-courses.html">
                                        ...
                                        {/* <!--<[col start]>--> */}
                                        <div className="col-9 item-two">
                                            <div className="tab-content overflow-hidden" id="v-pills-tabContent">

                                                {/* <!-- Course by Vendor /--> */}
                                                <div className="tab-pane fade show active" id="v-pills-course-vendor"
                                                    role="tabpanel" aria-labelledby="v-pills-course-vendor-tab"
                                                    style={{ paddingTop: "12px" }}>
                                                    <div className="mega-menu-v-tabs">
                                                        {/* <!--/ row start /--> */}
                                                        <div className="row m-0">
                                                            <div className="col-6 vendor-nav-col p-0">
                                                                <h5 className="mega-menu-vendor-heading w-100">
                                                                    Instructor-led Courses</h5>
                                                                <div className="row m-0">
                                                                    <div className="col-6">
                                                                        <div className="nav vendor-tab-pills nav-pills w-100"
                                                                            data-mouse="hover" id="v-pills-tab"
                                                                            role="tablist"
                                                                            aria-orientation="vertical">
                                                                            <a className="mega-menu-tab-link active"
                                                                                id="v-pills-course-vendinfosec-tab"
                                                                                data-toggle="pill"
                                                                                href="#v-pills-course-vendinfosec"
                                                                                role="tab"
                                                                                aria-controls="v-pills-course-vendinfosec"
                                                                                aria-selected="true">Threatsys
                                                                                Academy</a>

                                                                            <a className="mega-menu-tab-link "
                                                                                id="v-pills-course-vendora-tab"
                                                                                data-toggle="pill"
                                                                                href="#v-pills-course-vendora"
                                                                                role="tab"
                                                                                aria-controls="v-pills-course-vendora"
                                                                                aria-selected="false">EC Council</a>

                                                                            <a className="mega-menu-tab-link"
                                                                                id="v-pills-course-vendorb-tab"
                                                                                data-toggle="pill"
                                                                                href="#v-pills-course-vendorb"
                                                                                role="tab"
                                                                                aria-controls="v-pills-course-vendorb"
                                                                                aria-selected="false">(ISC)2</a>
                                                                            <a className="mega-menu-tab-link"
                                                                                id="v-pills-course-vendorc-tab"
                                                                                data-toggle="pill"
                                                                                href="#v-pills-course-vendorc"
                                                                                role="tab"
                                                                                aria-controls="v-pills-course-vendorc"
                                                                                aria-selected="false">ISACA</a>
                                                                            <a className="mega-menu-tab-link"
                                                                                id="v-pills-course-vendord-tab"
                                                                                data-toggle="pill"
                                                                                href="#v-pills-course-vendord"
                                                                                role="tab"
                                                                                aria-controls="v-pills-course-vendord"
                                                                                aria-selected="false">IAPP</a>
                                                                            <a className="mega-menu-tab-link"
                                                                                id="v-pills-course-vendore-tab"
                                                                                data-toggle="pill"
                                                                                href="#v-pills-course-vendore"
                                                                                role="tab"
                                                                                aria-controls="v-pills-course-vendore"
                                                                                aria-selected="false">ISO</a>
                                                                            <a className="mega-menu-tab-link"
                                                                                id="v-pills-course-vendorf-tab"
                                                                                data-toggle="pill"
                                                                                href="#v-pills-course-vendorf"
                                                                                role="tab"
                                                                                aria-controls="v-pills-course-vendorf"
                                                                                aria-selected="false">CompTIA</a>
                                                                            <a className="mega-menu-tab-link"
                                                                                id="v-pills-course-vendorg-tab"
                                                                                data-toggle="pill"
                                                                                href="#v-pills-course-vendorg"
                                                                                role="tab"
                                                                                aria-controls="v-pills-course-vendorg"
                                                                                aria-selected="false">AWS</a>
                                                                            <a className="mega-menu-tab-link"
                                                                                id="v-pills-course-vendorh-tab"
                                                                                data-toggle="pill"
                                                                                href="#v-pills-course-vendorh"
                                                                                role="tab"
                                                                                aria-controls="v-pills-course-vendorh"
                                                                                aria-selected="false">Cloud Security
                                                                                Alliance</a>
                                                                            <a className="mega-menu-tab-link"
                                                                                id="v-pills-course-vendori-tab"
                                                                                data-toggle="pill"
                                                                                href="#v-pills-course-vendori"
                                                                                role="tab"
                                                                                aria-controls="v-pills-course-vendori"
                                                                                aria-selected="false">Microsoft</a>
                                                                    ...
                                                                    <div className="col-6">
                                                                        ...
                                                                        <div className="tab-content"
                                                                            ...
                                                                            <div className="tab-pane active"
                                                                                id="v-pills-course-vendinfosec"
                                                                                role="tabpanel"
                                                                                aria-labelledby="v-pills-course-vendinfosec-tab">
                                                                                <ul
                                                                                    className="list-unstyled list-group w-100">
                                                                                    <li><a
                                                                                            href="javascript:void(0)">GRC
                                                                                            Hands-on</a></li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">Security
                                                                                            Architecture
                                                                                            Hands-on</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">SOC
                                                                                            Analyst Hands-on</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">PCI-DSS
                                                                                            Implementation
                                                                                            Training</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">APT
                                                                                            - Advanced Penetration
                                                                                            Testing</a></li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">AI-Powered
                                                                                            Cybersecurity Training
                                                                                        </a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            ...
                                                                                            Governance</a></li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">Certified
                                                                                            GRC Auditor (CGA)</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">DPO
                                                                                            Hands-on </a></li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">Splunk
                                                                                            Practical Approach</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">RSA
                                                                                            Archer</a></li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">SailPoint
                                                                                            IIQ Implementation &
                                                                                            Developer </a></li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">Practical
                                                                                            DevSecOps</a></li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">Threat
                                                                                            Hunting and DFIR</a>
                                                                                    </li>
                                                                                </ul>
                                                                            </div>
                                                                            <div className="tab-pane"
                                                                                id="v-pills-course-vendora"
                                                                                role="tabpanel"
                                                                                aria-labelledby="v-pills-course-vendora-tab">
                                                                                <ul
                                                                                    className="list-unstyled list-group w-100">
                                                                                    <li><a
                                                                                            href="javascript:void(0)">CEH
                                                                                            v13 AI</a></li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">CHFI
                                                                                            v11</a></li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">CND
                                                                                            v2</a></li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">CCISO</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">ECDE</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">CPENT</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">CSA</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">ECIH</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">ECES</a>
                                                                                    </li>
                                                                                    <li><a href="javascript:void(0)"
                                                                                            title="EC-Council Certified Security Specialist">ECSS</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">Disaster
                                                                                            Recovery Professional
                                                                                            v3</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">CASE</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">CASE</a>
                                                                                    </li>
                                                                                    <li><a href="javascript:void(0)"
                                                                                            title="Blockchain Fintech Certification">B|FC</a>
                                                                                    </li>
                                                                                </ul>
                                                                            </div>
                                                                            <div className="tab-pane"
                                                                                id="v-pills-course-vendorb"
                                                                                role="tabpanel"
                                                                                aria-labelledby="v-pills-course-vendorb-tab">
                                                                                <ul
                                                                                    className="list-unstyled list-group w-100">
                                                                                    <li><a
                                                                                    ...
                                                                                    <li><a
                                                                                            href="javascript:void(0)">CISSP</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">CCSP</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">ISSAP</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">SSCP</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">CGRC</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">CSSLP</a>
                                                                                    </li>
                                                                                </ul>
                                                                            </div>
                                                                            <div className="tab-pane"
                                                                                id="v-pills-course-vendorc"
                                                                                role="tabpanel"
                                                                                aria-labelledby="v-pills-course-vendorc-tab">
                                                                                <ul
                                                                                    className="list-unstyled list-group w-100">
                                                                                    <li><a
                                                                                            href="javascript:void(0)">CISA</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">CISM</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">CRISC</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">CGEIT</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">CDPSE</a>
                                                                                    </li>
                                                                                    <li><a href="javascript:void(0)"
                                                                                            title="CSX Cybersecurity Practitioner">CSX-P</a>
                                                                                    </li>
                                                                                    <li><a href="javascript:void(0)"
                                                                                            title="Advanced in AI Security Management">Advanced
                                                                                            in AI Security
                                                                                            Management
                                                                                            (AAISM)</a>
                                                                                    </li>
                                                                                    <li><a href="javascript:void(0)"
                                                                                            title="Advanced in AI Audit">Advanced
                                                                                            in AI Audit (AAIA)</a>
                                                                                    </li>
                                                                                </ul>
                                                                            </div>
                                                                            <div className="tab-pane"
                                                                                id="v-pills-course-vendord"
                                                                                role="tabpanel"
                                                                                aria-labelledby="v-pills-course-vendord-tab">
                                                                                <ul
                                                                                    className="list-unstyled list-group w-100">
                                                                                    <li><a
                                                                                            href="javascript:void(0)">CIPP/E</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">CIPM</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">CIPT</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">AIGP</a>
                                                                                    </li>
                                                                                </ul>
                                                                            </div>
                                                                            <div className="tab-pane"
                                                                                id="v-pills-course-vendore"
                                                                                role="tabpanel"
                                                                                aria-labelledby="v-pills-course-vendore-tab">
                                                                                <ul
                                                                                    className="list-unstyled list-group w-100">

                                                                                    <li><a
                                                                                            href="javascript:void(0)">ISO/IEC
                                                                                            27001:2022 Lead
                                                                                            Auditor</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                    ...
                                                                                    <li><a
                                                                                            href="javascript:void(0)">ISO
                                                                                            22301 Lead
                                                                                            Implementer</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">ISO
                                                                                            22301 Lead Auditor</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">ISO/IEC
                                                                                            20000 (ITSM) Lead
                                                                                    ...
                                                                                    <li><a
                                                                                            href="javascript:void(0)">ISO
                                                                                            31000: Risk Manager</a>
                                                                                    </li>

                                                                                </ul>
                                                                            </div>
                                                                            <div className="tab-pane"
                                                                                id="v-pills-course-vendorf"
                                                                                role="tabpanel"
                                                                                aria-labelledby="v-pills-course-vendorf-tab">
                                                                                <ul
                                                                                    className="list-unstyled list-group w-100">
                                                                                    <li><a
                                                                                    ...
                                                                                    <li><a
                                                                                            href="javascript:void(0)">CySA+</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">PenTest+</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">Network+</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">CASP+</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">Cloud+</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">A+</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">IT
                                                                                            Fundamentals</a></li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">Data+</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">DataSys+</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">Cloud
                                                                                            Essentials+</a></li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">Linux+</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                    ...
                                                                                    <li><a
                                                                                            href="javascript:void(0)">Server+</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">SecurityX</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">Tech+</a>
                                                                                    </li>

                                                                                </ul>
                                                                            </div>
                                                                            <div className="tab-pane"
                                                                                id="v-pills-course-vendorg"
                                                                                role="tabpanel"
                                                                                aria-labelledby="v-pills-course-vendorg-tab">
                                                                                <ul
                                                                                    className="list-unstyled list-group w-100">
                                                                                    <li><a
                                                                                            href="javascript:void(0)">AWS
                                                                                            Combo</a></li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">Cloud
                                                                            ...
                                                                            <div className="tab-pane"
                                                                                id="v-pills-course-vendorh"
                                                                                role="tabpanel"
                                                                                aria-labelledby="v-pills-course-vendorh-tab">
                                                                                <ul
                                                                                    className="list-unstyled list-group w-100">

                                                                                    <li><a
                                                                                            href="javascript:void(0)">CCSK
                                                                                            Plus v5</a></li>

                                                                                    <li><a
                                                                                            href="javascript:void(0)">CCZT
                                                                                            Training</a></li>

                                                                                </ul>
                                                                            </div>
                                                                            <div className="tab-pane"
                                                                                id="v-pills-course-vendori"
                                                                                role="tabpanel"
                                                                                aria-labelledby="v-pills-course-vendori-tab">
                                                                                <ul
                                                                                    className="list-unstyled list-group w-100">
                                                                                    <li><a
                                                                                            href="javascript:void(0)">AZ-104
                                                                                            & AZ-500 (Combo)</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">AZ-104</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">AZ-500</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                    ...
                                                                                    <li><a
                                                                                            href="javascript:void(0)">AZ-020T00-A</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">AZ040</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">AZ-204</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">AZ-220</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">AZ-304/AZ-301</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">AZ-303
                                                                                            / AZ-300</a></li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">AZ-305T00</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">AZ-400</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">AZ-400T00-A</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">AZ-900</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">AZ-2005</a>
                                                                                    </li>


                                                                                    <li><a
                                                                                            href="javascript:void(0)">SC-100:</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">SC
                                                                                            200</a></li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">SC-300</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">SC-900</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">SC
                                                                                            400</a></li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">SC-5001</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">SC-5002</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">SC-5003</a>
                                                                                    </li>


                                                                                    <li><a
                                                                                            href="javascript:void(0)">DP-090</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">DP-100</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">DP-203T00</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">DP-3014</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">DP-600T00-A</a>
                                                                                    </li>


                                                                                    <li><a
                                                                                            href="javascript:void(0)">MS-102:
                                                                                            Microsoft 365
                                                                                            Administrator</a></li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">MS-500:
                                                                                            Microsoft 365
                                                                                            Security</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">MS-900:
                                                                                            Microsoft 365
                                                                                            Fundamentals</a></li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">MS-4006-A</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">MB-260T00-A</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">Azure
                                                                                            MLOps from Microsoft</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">Power
                                                                                            BI Practical Training
                                                                                            Course</a></li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">PL-200T00</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">PL-300T00-A</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">IC-002T00</a>
                                                                                    </li>



                                                                                    <li><a
                                                                                            href="javascript:void(0)">AI-102
                                                                                            Microsoft Azure AI
                                                                                            Solution</a></li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">AI-050</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">AI-900</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">AI-102T00</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">AI-3016</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">AI-3018</a>
                                                                                    </li>
                                                                                    <li><a
                                                                                            href="javascript:void(0)">AI-Integrated
                                                                                            Microsoft Excel
                                                                                            Training</a>
                                                                                    </li>
                                                                ...
                                                                <div
                                                                    className="mega-menu-vendor-heading ppp text-center megamenu-btn mt-4">
                                                                    <a href="javascript:void(0)"
                                                                        className="d-flex justify-content-between">
                                                                       <span style={{ color: "#ffffff" }}>
  VIEW ALL INSTRUCTOR-LED COURSES
</span>
                                                                    </a>
                                                                </div>
                                                            </div>

                                                            <div className="col-6 top-trending-course-col">
                                                                <div
                                                                    className="mega-menu-vendor-heading text-center marquee">
                                                                    {/* <!-- <span
                                                                    style="border-radius: 3px; background: linear-gradient(267deg, #ffbf00 -15.61%, #f8c80c); color: #ffffff; display: inline; margin: 0 5px 0 0; padding: 5px; text-align: center;font-size: 12px;text-align: center;">
                                                                    TOP
                                                                </span> --> */}
                                                                ...
                                                                {/* <!--<[col start]>--> */}
                                                                <div
                                                                    className="d-flex justify-content-between position-relative trending-course-list">
                                                                    {/* <!--<[ul list start]>--> */}
                                                                    <ul className="list-unstyled list-group">
                                                                        <li><a href='javascript:void(0)'>AI-Powered
                                                                                Cybersecurity</a></li>
                                                                        <li><a href='javascript:void(0)'>AIGP
                                                                                – Artificial Intelligence Governance
                                                                                Professional</a></li>
                                                                        <li><a href='javascript:void(0)'>CISSP
                                                                                – Certified Information Systems
                                                                                Security
                                                                                Professional</a></li>
                                                                        <li><a href='javascript:void(0)'>CISA
                                                                                – Certified Information Systems
                                                                                Auditor</a></li>
                                                                        <li><a href='javascript:void(0)'>CCSP
                                                                                – Certified Cloud Security
                                                                                Professional</a></li>
                                                                        <li><a href='javascript:void(0)'>CISM
                                                                                – Certified Information Security
                                                                                Manager</a></li>
                                                                        <li><a href='javascript:void(0)'>CompTIA
                                                                                Security+</a></li>
                                                                        <li><a href='javascript:void(0)'>CEH
                                                                                – Certified Ethical Hacker</a></li>
                                                                        <li><a href='javascript:void(0)'>CIPP/E
                                                                                – Certified Information Privacy
                                                                                Professional</a></li>
                                                                        <li><a href='javascript:void(0)'>DPO
                                                                                – Data Protection Officer</a></li>
                                                                        <li><a href='javascript:void(0)'>CIPM
                                                                                – Certified Information Privacy
                                                                                Manager</a></li>
                                                                        <li><a href='javascript:void(0)'>CIPT
                                                                                – Certified Information Privacy
                                                                                Technologist</a></li>
                                                                        <li><a href='javascript:void(0)'>DevSecOps
                                                                                – Development, Security, and
                                                                                Operations</a></li>
                                                                        <li><a href='javascript:void(0)'>ISO
                                                                                42001 Lead Auditor</a></li>
                                                                        <li><a href='javascript:void(0)'>ISO
                                                                                27001 Lead Auditor</a></li>
                                                                        <li><a href='javascript:void(0)'>ISO
                                                                                27001 Lead Implementer</a></li>
                                                                        <li><a href='javascript:void(0)'>SOC
                                                                                – Security Operations Center</a>
                                                                        </li>
                                                                        <li><a href='javascript:void(0)'>Security
                                                                                Architecture</a></li>
                                                                        <li><a href='javascript:void(0)'>CCISO
                                                                                – Certified Chief Information
                                                                                Security
                                                                                Officer</a></li>
                                                                        <li><a href='javascript:void(0)'>CRISC
                                                                                – Certified in Risk and Information
                                                                                Systems Control</a></li>
                                                                        <li><a href='javascript:void(0)'>APT
                                                                                – Application Penetration
                                                                                Testing</a>
                                                                        </li>
                                                                        <li><a href='javascript:void(0)'>PCI-DSS
                                                                                Implementation Training</a></li>
                                                                        <li><a href='javascript:void(0)'>Azure
                                                                                – Microsoft Azure</a></li>
                                                                        <li><a href='javascript:void(0)'>AWS
                                                                                – Amazon Web Services</a></li>
                                                                        <li><a href='javascript:void(0)'>GRC
                                                                                – Governance, Risk, and
                                                                                Compliance</a>
                                                                        </li>
                                                                        <li><a href='javascript:void(0)'>RSA
                                                                                Archer</a></li>
                                                                        <li><a
                                                                                href='javascript:void(0)'>SailPoint</a>
                                                                        </li>
                                                                        <li><a href='javascript:void(0)'>Splunk</a>
                                                                        </li>
                                                                    </ul>
                                                                    {/* <!--<[ul list end]>--> */}
                                                                </div>
                                                                {/* <!--<[col start]>--> */}
                                                                <div
                                                                    className="mega-menu-vendor-heading text-center pppp megamenu-btn mb-3">
                                                                    <a href="./our-courses.html"
                                                                        className="d-flex justify-content-between">
                                                                        <span style={{ color: "#ffffff" }}>VIEW ALL
                                                                            COURSES</span>
                                                                    </a>
                                                                </div>
                                                            </div>
                                                ...
                                                <div className="tab-pane fade" id="v-pills-domain-expertise"
                                                    role="tabpanel" aria-labelledby="v-pills-domain-expertise-tab">
                                                    <div className="mega-menu-v-tabs">
                                                        {/* <!--/ row start /--> */}
                                                        <div className="row">
                                                            <div className="col-3 domain-expertise-col">
                                                                <a href="javascript:void(0)">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                        width="26" height="30" viewBox="0 0 26 30"
                                                                        fill="none">
                                                                        <g clipPath="url(#clip0_4191_3045)">
                                                                            <path
                                                            ...
                                                            <div className="col-3 domain-expertise-col">
                                                                <a href="javascript:void(0)">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                        width="23" height="30" viewBox="0 0 23 30"
                                                                        fill="none">
                                                                        <g clipPath="url(#clip0_4191_3070)">
                                                                            <path
                                                                                d="M20.3182 3.54545H17.4545C17.0455 2.45455 16.0909 1.77273 15 1.77273H13.9091C13.6364 0.681818 12.6818 0 11.4545 0C10.2273 0 9.27273 0.681818 9 1.77273H7.90909C6.81818 1.77273 5.86364 2.45455 5.45455 3.54545H2.59091C1.22727 3.54545 0 4.77273 0 6.13636V27.2727C0 28.7727 1.22727 30 2.59091 30H20.1818C21.6818 30 22.7727 28.7727 22.7727 27.4091V6.13636C22.9091 4.77273 21.8182 3.54545 20.3182 3.54545ZM7.09091 4.36364C7.09091 3.81818 7.5 3.54545 7.90909 3.54545H9.68182C10.2273 3.54545 10.5 3.13636 10.5 2.72727C10.5 2.18182 10.9091 1.90909 11.3182 1.90909C11.8636 1.90909 12.1364 2.31818 12.1364 2.72727C12.1364 3.27273 12.5455 3.54545 12.9545 3.54545H15C15.5455 3.54545 15.8182 3.95455 15.8182 4.36364V5.18182H7.09091V4.36364ZM21.1364 27.4091C21.1364 27.9545 20.7273 28.2273 20.3182 28.2273H2.59091C2.04545 28.2273 1.77273 27.8182 1.77273 27.4091V6.13636C1.77273 5.59091 2.18182 5.31818 2.59091 5.31818H5.18182V6.13636C5.18182 6.68182 5.59091 6.95455 6 6.95455H16.6364C17.1818 6.95455 17.4545 6.54545 17.4545 6.13636V5.31818H20.0455C20.5909 5.31818 20.8636 5.72727 20.8636 6.13636L21.1364 27.4091Z"
                                                                                fill="#686868" />
                                                                            <path
                                                                                d="M8.86364 10.6367H5.31818C4.77273 10.6367 4.5 11.0458 4.5 11.4549C4.5 12.0004 4.90909 12.2731 5.31818 12.2731H8.86364C9.40909 12.2731 9.68182 11.864 9.68182 11.4549C9.68182 11.0458 9.27273 10.6367 8.86364 10.6367Z"
                                                                                fill="#686868" />
                                                                            <path
                                                                                d="M8.86364 16.7734H5.31818C4.77273 16.7734 4.5 17.1825 4.5 17.5916C4.5 18.1371 4.90909 18.4098 5.31818 18.4098H8.86364C9.40909 18.4098 9.68182 18.0007 9.68182 17.5916C9.68182 17.1825 9.27273 16.7734 8.86364 16.7734Z"
                                                                                fill="#686868" />
                                                                            <path
                                                                                d="M8.86364 22.9102H5.31818C4.77273 22.9102 4.5 23.3192 4.5 23.7283C4.5 24.1374 4.90909 24.5465 5.31818 24.5465H8.86364C9.40909 24.5465 9.68182 24.1374 9.68182 23.7283C9.68182 23.3192 9.27273 22.9102 8.86364 22.9102Z"
                                                                                fill="#686868" />
                                                                            <path
                                                                                d="M18.2717 9.95526C17.8626 9.54616 17.3171 9.54616 17.0444 9.95526L14.9989 12.0007L13.908 10.9098C13.4989 10.5007 12.9535 10.5007 12.5444 10.9098C12.2717 11.1825 12.2717 11.728 12.5444 12.1371L14.3171 13.9098C14.4535 14.0462 14.7262 14.1825 14.9989 14.1825C15.2717 14.1825 15.408 14.0462 15.6808 13.9098L18.2717 11.3189C18.6808 10.9098 18.6808 10.3643 18.2717 9.95526Z"
                                                                                fill="#686868" />
                                                                            <path
                                                                                d="M18.2727 15.2717C17.8636 14.8626 17.3182 14.8626 17.0455 15.2717L15 17.3171L13.9091 16.2262C13.5 15.8171 12.9545 15.8171 12.6818 16.2262C12.2727 16.6353 12.2727 17.1808 12.6818 17.4535L14.4545 19.2262C14.5909 19.3626 14.8636 19.4989 15.1364 19.4989C15.4091 19.4989 15.5455 19.3626 15.8182 19.2262L18.4091 16.6353C18.6818 16.2262 18.6818 15.5444 18.2727 15.2717Z"
                                                                                fill="#686868" />
                                                                            <path
                                                                                d="M16.2262 23.8633L17.3171 22.7724C17.7262 22.3633 17.7262 21.8178 17.3171 21.5451C16.908 21.136 16.3626 21.136 16.0898 21.5451L14.9989 22.636L13.908 21.5451C13.4989 21.136 12.9535 21.136 12.6808 21.5451C12.2717 21.8178 12.2717 22.3633 12.5444 22.636L13.6353 23.7269L12.5444 24.8178C12.2717 25.3633 12.2717 25.9087 12.5444 26.1815C12.6808 26.3178 12.9535 26.4542 13.2262 26.4542C13.4989 26.4542 13.6353 26.3178 13.908 26.1815L14.9989 25.0906L16.0898 26.1815C16.2262 26.3178 16.4989 26.4542 16.7717 26.4542C17.0444 26.4542 17.1808 26.3178 17.4535 26.1815C17.8626 25.7724 17.8626 25.2269 17.4535 24.9542L16.2262 23.8633Z"
                                                                                fill="#686868" />
                                                                        </g>
                                                                        <defs>
                                                                            <clipPath id="clip0_4191_3070">
                                                                                <rect width="22.9091" height="30"
                                                                                    fill="white" />
                                                                            </clipPath>
                                                                        </defs>
                                                                    </svg>
                                                            ...
                                                            <div className="col-3 domain-expertise-col">
                                                                <a href="javascript:void(0)">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                        ...
                                                                        fill="none">
                                                                        <path
                                                                            d="M3.22003 27.907H13.9535C14.5975 27.907 15.0268 27.4776 15.0268 26.8336C15.0268 26.1896 14.5975 25.7603 13.9535 25.7603H3.22003C2.57603 25.7603 2.14669 25.3309 2.14669 24.6869V19.3202H11.8068C12.4508 19.3202 12.8801 18.8909 12.8801 18.2469C12.8801 17.6029 12.4508 17.1735 11.8068 17.1735H2.14669V10.7334H25.7603V12.8801C25.7603 13.5241 26.1896 13.9535 26.8336 13.9535C27.4776 13.9535 27.907 13.5241 27.907 12.8801V3.22003C27.907 1.39535 26.5116 0 24.6869 0H3.22003C1.39535 0 0 1.39535 0 3.22003V24.6869C0 26.5116 1.39535 27.907 3.22003 27.907ZM3.22003 2.14669H24.6869C25.3309 2.14669 25.7603 2.57603 25.7603 3.22003V8.58676H2.14669V3.22003C2.14669 2.57603 2.57603 2.14669 3.22003 2.14669Z"
                                                                            fill="#686868" />
                                                                        <path
                                                                            d="M4.29209 7.51388C4.9361 7.51388 5.36544 7.08454 5.36544 6.44053C5.36544 6.11853 5.2581 5.90386 5.04344 5.68919C4.6141 5.25985 3.97009 5.25985 3.54075 5.68919C3.32608 5.90386 3.21875 6.11853 3.21875 6.44053C3.21875 6.76254 3.32608 6.9772 3.54075 7.19187C3.75542 7.40654 3.97009 7.51388 4.29209 7.51388Z"
                                                                            fill="#686868" />
                                                                        <path
                                                                            d="M7.51475 7.51388C8.15876 7.51388 8.5881 7.08454 8.5881 6.44053C8.5881 6.11853 8.48076 5.90386 8.26609 5.68919C7.83675 5.25985 7.19275 5.25985 6.76341 5.68919C6.54874 5.90386 6.44141 6.11853 6.44141 6.44053C6.44141 6.76254 6.54874 6.9772 6.76341 7.19187C6.97808 7.40654 7.19275 7.51388 7.51475 7.51388Z"
                                                                            fill="#686868" />
                                                                        <path
                                                                            d="M3.54075 14.2751C3.32608 14.4898 3.21875 14.7045 3.21875 15.0265C3.21875 15.3485 3.32608 15.5631 3.54075 15.7778C3.97009 16.2071 4.6141 16.2071 5.04344 15.7778C5.47277 15.3485 5.47277 14.7045 5.04344 14.2751C4.6141 13.8458 3.97009 13.8458 3.54075 14.2751Z"
                                                                            fill="#686868" />
                                                                        <path
                                                                            d="M6.76341 14.2751C6.54874 14.4898 6.44141 14.7045 6.44141 15.0265C6.44141 15.3485 6.54874 15.5631 6.76341 15.7778C7.19275 16.2071 7.83675 16.2071 8.26609 15.7778C8.69543 15.3485 8.69543 14.7045 8.26609 14.2751C7.83675 13.8458 7.19275 13.8458 6.76341 14.2751Z"
                                                                            fill="#686868" />
                                                                        <path
                                                                            d="M3.54075 22.8611C3.32608 23.0757 3.21875 23.2904 3.21875 23.6124C3.21875 23.9344 3.32608 24.1491 3.54075 24.3638C3.97009 24.7931 4.6141 24.7931 5.04344 24.3638C5.47277 23.9344 5.47277 23.2904 5.04344 22.8611C4.6141 22.4317 3.97009 22.4317 3.54075 22.8611Z"
                                                                            fill="#686868" />
                                                                        <path
                                                                            d="M6.76341 22.8611C6.54874 23.0757 6.44141 23.2904 6.44141 23.6124C6.44141 23.9344 6.54874 24.1491 6.76341 24.3638C7.19275 24.7931 7.83675 24.7931 8.26609 24.3638C8.69543 23.9344 8.69543 23.2904 8.26609 22.8611C7.83675 22.4317 7.19275 22.4317 6.76341 22.8611Z"
                                                                            fill="#686868" />
                                                                        <path
                                                                            d="M29.5164 15.0255C29.1944 14.8109 28.8724 14.8109 28.5504 14.9182C26.5111 15.7769 24.2571 15.4549 22.647 13.9522C22.2177 13.6302 21.5737 13.6302 21.1444 14.0595C19.5343 15.4549 17.2803 15.7769 15.241 14.9182C14.7043 14.7035 14.0603 14.9182 13.8456 15.4549C13.7383 15.5622 13.7383 15.7769 13.7383 15.8842V18.6749C13.7383 23.0756 16.0996 27.047 19.9637 29.0863L21.359 29.8377C21.681 30.0524 22.003 30.0524 22.325 29.8377L23.7204 29.0863C27.5844 27.047 29.9458 23.0756 29.9458 18.6749V15.8842C30.0531 15.5622 29.8385 15.2402 29.5164 15.0255ZM27.9064 18.7822C27.9064 22.3243 25.9744 25.6516 22.8617 27.2617L22.003 27.691L21.1444 27.2617C18.0317 25.5443 16.0996 22.3243 16.0996 18.7822V17.3869C18.139 17.8162 20.2857 17.3869 22.1104 16.2062C23.8277 17.3869 25.9744 17.8162 28.1211 17.3869V18.7822H27.9064Z"
                                                                            fill="#686868" />
                                                                        <path
                                                                            d="M25.0082 18.5681L21.4661 22.1101L20.0708 20.7148C19.6414 20.2854 18.9974 20.2854 18.5681 20.7148C18.1388 21.1441 18.1388 21.7881 18.5681 22.2175L20.7148 24.3642C21.1441 24.7935 21.7881 24.7935 22.2175 24.3642L26.5108 20.0708C26.9402 19.6414 26.9402 18.9974 26.5108 18.5681C26.0815 18.1388 25.4375 18.1388 25.0082 18.5681Z"
                                                                            fill="#686868" />
                                                                    </svg>
                                                                    <p>
                                                                        Data Privacy
                                                            ...
                                                            <div className="col-3 domain-expertise-col">
                                                                <a href="javascript:void(0)">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                        width="30" height="30" viewBox="0 0 30 30"
                                                                        fill="none">
                                                                        <g clipPath="url(#clip0_4191_3148)">
                                                                            <path
                                                                                d="M27.84 26.2819H2.16C0.96 26.2819 0 25.3219 0 24.1219V7.20187C0 6.00188 0.96 5.04187 2.16 5.04187H4.08C4.56 5.04187 5.04 5.40188 5.04 6.00188C5.04 6.60188 4.56 6.84187 4.08 6.84187H2.16C2.04 6.84187 1.92 6.96187 1.92 7.20187V24.1219C1.92 24.2419 2.04 24.4819 2.28 24.4819H27.96C28.08 24.4819 28.32 24.3619 28.32 24.1219V7.20187C28.32 7.08188 28.2 6.84187 27.96 6.84187H26.04C25.56 6.84187 25.08 6.48188 25.08 5.88188C25.08 5.28188 25.56 4.92188 26.04 4.92188H27.96C29.04 5.04187 30 6.00188 30 7.20187V24.1219C30 25.3219 29.04 26.2819 27.84 26.2819Z"
                                                                                fill="#686868" />
                                                                            <path
                                                                                d="M29.04 21.8419H0.96C0.48 21.8419 0 21.3619 0 20.8819C0 20.4019 0.36 19.9219 0.96 19.9219H29.04C29.52 19.9219 30 20.4019 30 20.8819C30 21.3619 29.52 21.8419 29.04 21.8419Z"
                                                                                fill="#686868" />
                                                                            <path
                                                                                d="M19.0796 29.9989H10.9196C10.5596 29.9989 10.1996 29.7589 10.0796 29.3989C9.95958 29.0389 9.95958 28.6789 10.3196 28.3189C11.5196 27.1189 11.8796 25.1989 11.8796 25.1989C11.9996 24.7189 12.4796 24.3589 12.9596 24.3589C13.4396 24.4789 13.7996 24.8389 13.7996 25.4389C13.7996 25.5589 13.5596 26.7589 12.8396 28.0789H17.2796C16.5596 26.7589 16.3196 25.4389 16.3196 25.4389C16.1996 24.9589 16.5596 24.4789 17.1596 24.3589C17.6396 24.2389 18.1196 24.5989 18.2396 25.1989C18.2396 25.1989 18.4796 26.9989 19.6796 28.3189C19.9196 28.4389 20.0396 28.7989 20.0396 29.0389C20.0396 29.6389 19.5596 29.9989 19.0796 29.9989Z"
                                                                                fill="#686868" />
                                                                            <path
                                                                                d="M14.9986 17.52C14.8786 17.52 14.7586 17.52 14.6386 17.4C14.3986 17.28 7.55859 14.28 7.55859 8.16V3.12C7.55859 2.76 7.79859 2.4 8.15859 2.28L14.6386 0C14.8786 0 15.1186 0 15.3586 0L21.9586 2.28C22.3186 2.4 22.5586 2.76 22.5586 3.12V8.16C22.5586 14.28 15.7186 17.28 15.4786 17.4C15.2386 17.52 15.1186 17.52 14.9986 17.52ZM9.35859 3.84V8.16C9.35859 12.36 13.6786 14.88 14.9986 15.48C16.3186 14.76 20.6386 12.36 20.6386 8.16V3.84L14.9986 1.92L9.35859 3.84Z"
                                                                                fill="#686868" />
                                                                            <path
                                                                                d="M14.4006 11.88C14.1606 11.88 13.9206 11.76 13.6806 11.64L11.1606 9.12002C10.8006 8.76002 10.8006 8.16002 11.1606 7.80002C11.5206 7.44002 12.1206 7.44002 12.4806 7.80002L14.1606 9.48002L17.2806 5.40002C17.6406 5.04002 18.1206 4.92002 18.6006 5.16002C18.9606 5.52002 19.0806 6.00002 18.8406 6.48002L15.1206 11.52C15.0006 11.76 14.7606 11.88 14.4006 11.88Z"
                                                                                fill="#686868" />
                                                                        </g>
                                                                        <defs>
                                                            ...
                                                            <div className="col-3 domain-expertise-col">
                                                                <a href="javascript:void(0)">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                        ...
                                                                        fill="none">
                                                                        <g clipPath="url(#clip0_4191_3158)">
                                                                            <path
                                                                                d="M17.25 17.25C17.25 16.75 16.875 16.375 16.375 16.375H7.125C6.625 16.375 6.25 16.75 6.25 17.25C6.25 17.75 6.625 18.125 7.125 18.125H16.375C16.875 18.125 17.25 17.75 17.25 17.25Z"
                                                                                fill="#686868" />
                                                                            <path
                                                                                d="M17.25 12.75C17.25 12.25 16.875 11.875 16.375 11.875H7.125C6.625 11.875 6.25 12.25 6.25 12.75C6.25 13.25 6.625 13.625 7.125 13.625H16.375C16.875 13.5 17.25 13.125 17.25 12.75Z"
                                                                                fill="#686868" />
                                                                            <path
                                                                                d="M7.125 21C6.625 21 6.25 21.375 6.25 21.875C6.25 22.375 6.625 22.75 7.125 22.75H11.25C11.75 22.75 12.125 22.375 12.125 21.875C12.125 21.375 11.75 21 11.25 21H7.125Z"
                                                                                fill="#686868" />
                                                                            <path
                                                                                d="M15.25 28.25H4.375C2.875 28.25 1.625 27 1.625 25.5V8.875H5.625C7.5 8.875 8.875 7.5 8.875 5.75V1.75H21.375C22.875 1.75 24.125 3 24.125 4.5V15.5C24.125 16 24.5 16.375 25 16.375C25.5 16.375 25.875 16 25.875 15.5V4.375C25.875 1.875 23.875 0 21.5 0H7.125C6 0 4.875 0.5 4 1.25L1.25 4C0.5 4.875 0 6 0 7.125V25.625C0 28.125 2 30 4.375 30H15.125C15.625 30 16 29.625 16 29.125C16 28.625 15.625 28.25 15.25 28.25ZM2.5 5.25L5.25 2.5C5.75 2 6.375 1.75 7.125 1.75V5.75C7.125 6.5 6.5 7.125 5.75 7.125H1.75C1.75 6.375 2 5.75 2.5 5.25Z"
                                                                                fill="#686868" />
                                                                            <path
                                                                                d="M22.5 30C22.75 30 23 30 23.25 29.875L23.625 29.75C26.125 28.75 27.75 26.375 27.75 23.5V21.75C27.75 20.875 27.125 20 26.125 19.875C25.25 19.75 24.375 19.375 23.375 18.75C22.75 18.375 21.875 18.375 21.25 18.75C20.375 19.375 19.5 19.75 18.5 19.875C17.625 20 16.875 20.875 16.875 21.75V23.25C16.875 26.125 18.75 28.75 21.375 29.875C21.875 30 22.125 30 22.5 30ZM18.625 21.75C18.625 21.5 18.75 21.375 19 21.375C20.125 21.125 21.125 20.75 22.25 20.125C22.375 20.125 22.375 20 22.5 20C22.625 20 22.625 20 22.75 20.125C23.75 20.75 24.875 21.25 26 21.375C26.25 21.375 26.375 21.625 26.375 21.75V23.5C26.375 25.625 25.125 27.625 23.125 28.375L22.75 28.5C22.625 28.5 22.375 28.5 22.25 28.5C20.125 27.625 18.625 25.625 18.625 23.25V21.75Z"
                                                                                fill="#686868" />
                                                                            <path
                                                                                d="M21.875 26.125C22.125 26.125 22.25 26 22.375 25.875L24.875 23.375C25.125 23.125 25.125 22.625 24.875 22.375C24.625 22.125 24.125 22.125 23.875 22.375L21.875 24.375L21 23.5C20.75 23.25 20.25 23.25 20 23.5C19.75 23.75 19.75 24.25 20 24.5L21.375 25.875C21.5 26.125 21.75 26.125 21.875 26.125Z"
                                                                                fill="#686868" />
                                                                        </g>
                                                                        <defs>
                                                                            <clipPath id="clip0_4191_3158">
                                                                                <rect width="27.75" height="30"
                                                                                    fill="white" />
                                                                            </clipPath>
                                                                        </defs>
                                                                    </svg>
                                                            ...
                                                            <div className="col-3 domain-expertise-col">
                                                                <a href="javascript:void(0)">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                        width="30" height="30" viewBox="0 0 30 30"
                                                                        fill="none">
                                                                        <g clipPath="url(#clip0_17762_1940)">
                                                                            <path
                                                                                d="M23.7812 15V22.5C23.7812 23.19 23.2212 23.75 22.5312 23.75C21.8413 23.75 21.2812 23.19 21.2812 22.5V15C21.2812 14.31 21.8413 13.75 22.5312 13.75C23.2212 13.75 23.7812 14.31 23.7812 15ZM14.5062 8.39625L18.345 22.1825C18.5638 22.97 17.9725 23.75 17.1537 23.75C16.6 23.75 16.115 23.3825 15.9638 22.85L15.16 20H8.6525L7.84875 22.85C7.69875 23.3825 7.2125 23.75 6.65875 23.75C5.84125 23.75 5.24875 22.97 5.4675 22.1825L9.33125 8.2975C9.5075 7.5375 10.0075 6.8975 10.7038 6.54125C11.4138 6.17625 12.2287 6.15375 13.0025 6.47875C13.7362 6.78625 14.2988 7.5 14.5075 8.3975L14.5062 8.39625ZM14.455 17.5L12.0437 8.95625C12.0075 8.81375 11.805 8.81375 11.77 8.95625L9.35875 17.5H14.455ZM28.7825 12.5C28.0925 12.5 27.5325 13.06 27.5325 13.75V23.75C27.5325 25.8175 25.85 27.5 23.7825 27.5H6.28125C4.21375 27.5 2.53125 25.8175 2.53125 23.75V6.25C2.53125 4.1825 4.21375 2.5 6.28125 2.5H16.2812C16.9712 2.5 17.5312 1.94 17.5312 1.25C17.5312 0.56 16.9712 0 16.2812 0H6.28125C2.835 0 0.03125 2.80375 0.03125 6.25V23.75C0.03125 27.1962 2.835 30 6.28125 30H23.7812C27.2275 30 30.0312 27.1962 30.0312 23.75V13.75C30.0312 13.06 29.4712 12.5 28.7812 12.5H28.7825ZM20.22 6.475L22.555 7.45875L23.4863 9.79C23.6875 10.295 24.1763 10.625 24.72 10.625C25.2638 10.625 25.7513 10.2937 25.9538 9.79L26.88 7.4725L29.1975 6.54625C29.7025 6.345 30.0325 5.85625 30.0325 5.3125C30.0325 4.76875 29.7013 4.28125 29.1975 4.07875L26.88 3.1525L25.9538 0.835C25.75 0.33125 25.2612 0 24.7188 0C24.1763 0 23.6875 0.33125 23.485 0.835L22.5638 3.13875L20.2638 4.01C19.7563 4.2025 19.4163 4.685 19.4062 5.2275C19.3962 5.77125 19.7188 6.265 20.2188 6.47625L20.22 6.475Z"
                                                                                fill="#484848" />
                                                                        </g>
                                                                        <defs>
                                                                            <clipPath id="clip0_17762_1940">
                                                                                <rect width="30" height="30"
                                                                                    fill="white" />
                                                                            </clipPath>
                                                                        </defs>
                                                ...
                                                <div className="tab-pane fade" id="v-pills-career-oriented"
                                                    role="tabpanel" aria-labelledby="v-pills-career-oriented-tab">
                                                    {/* <!--/ row start /--> */}
                                                    <div className="row">
                                                        <div className="col-3 mt-3 career-oriented-course-item">
                                                            <a href="javascript:void(0)">
                                                                <p>
                                                                    Security Architecture Hands-on Training </p>
                                                            </a>
                                                        </div>
                                                        <div className="col-3 mt-3 career-oriented-course-item">
                                                            <a href="javascript:void(0)">
                                                                <p>
                                                                    Advanced Cloud Security Governance Training </p>
                                                            </a>
                                                        </div>
                                                        <div className="col-3 mt-3 career-oriented-course-item">
                                                            <a href="javascript:void(0)">
                                                                <p>
                                                                    Cyber Security Expert Online Training </p>
                                                            </a>
                                                        </div>
                                                        <div className="col-3 mt-3 career-oriented-course-item">
                                                            <a href="javascript:void(0)">
                                                        ...
                                                        <div className="col-3 mt-3 career-oriented-course-item">
                                                            <a href="javascript:void(0)">
                                                                <p>
                                                                    Cyber Security Analyst Training Course </p>
                                                            </a>
                                                        </div>
                                                        <div className="col-3 mt-3 career-oriented-course-item">
                                                            <a href="javascript:void(0)">
                                                                <p>
                                                                    Azure Administrator &#038; Security (AZ-104 +
                                                                    AZ-500) Combo Training </p>
                                                            </a>
                                                        </div>
                                                        <div className="col-3 mt-3 career-oriented-course-item">
                                                            <a href="javascript:void(0)">
                                                                <p>
                                                                    AWS Combo (Architecture Foundation + Security
                                                                    Speciality) Training </p>
                                                            </a>
                                                        </div>
                                                        <div className="col-3 mt-3 career-oriented-course-item">
                                                            <a href="javascript:void(0)">
                                                        ...
                                                        <div className="col-3 mt-3 career-oriented-course-item">
                                                            <a href="javascript:void(0)">
                                                                <p>
                                                                    Information Security Manager Online Training
                                                                    Course
                                                                </p>
                                                            </a>
                                                        </div>
                                                ...
                                                {/* <!--/ combo course start /--> */}
                                                <div className="tab-pane fade" id="v-pills-combo-courses"
                                                    role="tabpanel" aria-labelledby="v-pills-combo-courses-tab">
                                                    {/* <!--/ row start /--> */}
                                                    <div className="row">
                                                        <div className="col-3 mt-3 career-oriented-course-item">
                                                            <a href="javascript:void(0)">
                                                        ...
                                                        <div className="col-3 mt-3 career-oriented-course-item">
                                                            <a href="javascript:void(0)">
                                                                <p>
                                                                    Pentester Combo Training &#038; Certification
                                                                    Course
                                                                </p>
                                                            </a>
                                                        </div>
                                                        ...
                                                        <div className="col-3 mt-3 career-oriented-course-item">
                                                            <a href="javascript:void(0)">
                                                                <p>
                                                                    Enterprise Security Governance &#8211; Combo of
                                                                    CISSP &#038; CCSP Online Training Course </p>
                                                            </a>
                                                        </div>
                                                        <div className="col-3 mt-3 career-oriented-course-item">
                                                            <a href="javascript:void(0)">
                                                ...
                                                {/* <!--/ new courses start /--> */}
                                                <div className="tab-pane fade" id="v-pills-new-course" role="tabpanel"
                                                    aria-labelledby="v-pills-new-course-tab">
                                                    {/* <!--/ row start /--> */}
                                                    <div className="row">
                                                        <div className="col-3 career-oriented-course-item">
                                                            <a href="javascript:void(0)">
                                                                <p>
                                                                    AI Skills Mastery Program </p>
                                                                {/* <!-- <div className="coc-course-duration">
                                                                                            <i className="fa fa-calendar-o"></i>
                                                                                            <span>live classes: 40 hrs</span>
                                                                                        </div> --> */}
                                                            </a>
                                                        </div>
                                                        <div className="col-3 career-oriented-course-item">
                                                            <a href="javascript:void(0)">
                                                                <p>
                                                                    CompTIA Tech+ Certification Training </p>
                                                                {/* <!-- <div className="coc-course-duration">
                                                                                            <i className="fa fa-calendar-o"></i>
                                                                                            <span>live classes: 40 hrs</span>
                                                                                        </div> --> */}
                                                        ...
                                                        <div className="col-3 career-oriented-course-item">
                                                            <a href="javascript:void(0)">
                                                                <p>
                                                                    CompTIA SecurityX Certification Training </p>
                                                                {/* <!-- <div className="coc-course-duration">
                                                                                            <i className="fa fa-calendar-o"></i>
                                                                                            <span>live classes: 40 hrs</span>
                                                                                        </div> --> */}
                                                        ...
                                                        <div className="col-3 career-oriented-course-item">
                                                            <a href="javascript:void(0)">
                                                                <p>
                                                                    CompTIA Server+ Certification Training </p>
                                                                {/* <!-- <div className="coc-course-duration">
                                                                                            <i className="fa fa-calendar-o"></i>
                                                                                            <span>live classes: 40 hrs</span>
                                                                                        </div> --> */}
                                                        ...
                                                        <div className="col-3 career-oriented-course-item">
                                                            <a href="javascript:void(0)">
                                                                <p>
                                                                    CompTIA DataX (Plus) Certification Training </p>
                        ...
                        {/* <input type="text" className="input-field" placeholder="Search For Course.." name="s" value=""
                            autoComplete="off" required="required" pattern="[a-zA-Z0-9\s]+"
          ...
          <ul>
            ...
            <li className="menu-item-has-children">
              ...
              <ul className="dp-menu">
                <li><Link href="/about-us">Threatsys Academy</Link></li>
                <li><Link href="/our-team">Our Team</Link></li>
                <li><Link href="/Clientele">Our Clientele</Link></li>
                <li><Link href="/Instructors">Our Instructor</Link></li>
            ...
            <li className="menu-item-has-children">
              <Link href="/our-courses">Services</Link>
              <ul className="dp-menu">
                <li><Link href="/corporate-training">Corporate Training</Link></li>
                <li><Link href="/hire-a-trainer">Hire-a-Trainer</Link></li>
                <li><Link href="/OneOnOneTraining">1-on-1 Training</Link></li>
                <li><Link href="/CareerMentorship">Career Mentorship Program</Link></li>
                <li>
                  <a
            ...
            <li className="menu-item-has-children">
              <Link href="/free-events">Resources</Link>
              <ul className="dp-menu">
                <li><Link href="/FreeEvents">Free Events</Link></li>
                <li><Link href="/free-test">Free Practice Tests</Link></li>
                <li><Link href="/free-cyber-security-training">Free Cyber Security Training</Link></li>
...
<div className="hamenu">
        <div className="logo-close">
          <div>
          <Image
  src="/images/Threatsys_academy.png"
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-7 col-md-6 col-12">
              <div className="cont-info full-width for-res">
                ...
                <ul className="main-menu rest">
                  ...
                  <li>
                    ...
                    <div className="ham-sub-menu">
                      <ul>
                        <li>
                          <a href="about-us.html" className="sub-link">
                            Threatsys Academy
                          </a>
                        </li>
                        <li>
                          <a href="our-team.html" className="sub-link">
                            Our Team
                          </a>
                        </li>
                        <li>
                          <a href="our-clientele.html" className="sub-link">
                            Our Clientele
                          </a>
                        </li>
                        <li>
                          <a href="our-instructor.html" className="sub-link">
                            Our Instructor
                          </a>
                        </li>
                        <li>
                          <a href="career.html" className="sub-link">
                            Careers
                          </a>
                        </li>
                        <li>
                          <a href="testimonial.html" className="sub-link">
                            Testimonial
                          </a>
                        </li>
                        <li>
                          <a href="success-stories.html" className="sub-link">
                            Success Stories
                          </a>
                        </li>
                      </ul>
                  ...
                  <li>
                    ...
                    <div className="ham-sub-menu">
                      <ul>
                        ...
                        <li>
                          <a href="hire-a-trainer.html" className="sub-link">
                            Hire-a-Trainer
                          </a>
                        </li>
                        <li>
                          <a href="1-on-1-training.html" className="sub-link">
                            1-on-1 Training
                          </a>
                        </li>
                        <li>
                          <a
                            href="career-mentorship-program.html"
                            className="sub-link"
                          >
                  ...
                  <li>
                    <div className="o-hidden">
                      <a href="training-calendar.html" className="link">
                        <span
                          className="fill-text"
                          data-text="Training Calendar"
                        >
                          Training Calendar
                        </span>
                      </a>
                  ...
                  <li>
                    <div className="o-hidden">
                      <div className="link cursor-pointer dmenu">
                        <span className="fill-text" data-text="Resources">
                          Resources
                        </span>
                        <i></i>
                      </div>
                    ...
                    <div className="ham-sub-menu">
                      <ul>
                        <li>
                          <a href="free-events.html" className="sub-link">
                            Free events
                          </a>
                        </li>
                        <li>
                          <a
                            href="free-practice-tests.html"
                            className="sub-link"
                          >
                            Free Practice Tests
                          </a>
                        ...
                        <li>
                          <a
                            href="free-cyber-security-training.html"
                            className="sub-link"
                          >
                        ...
                        <li>
                          <a href="blog.html" className="sub-link">
                            Blog
                          </a>
                        </li>
                      </ul>
                  ...
                  <li>
                    <div className="o-hidden">
                      <a href="self-paced-learning.html" className="link">
                        <span
                          className="fill-text"
                          data-text="Self-Paced Learning"
                        >
                          Self-Paced Learning
                        </span>
                      </a>
                  ...
                  <li>
                    <div className="o-hidden">
                      <a href="./case-study.html" className="link">
                        <span className="fill-text" data-text="Case Study">
                          Case Study
                        </span>
                      </a>
                    </div>
                  ...
                  <li>
                    <div className="o-hidden">
                      <a href="contact-us.html" className="link">
                  ...
                  <li>
                    <div className="o-hidden">
                      <a href="privacy-policy.html" className="link">
                        <span className="fill-text" data-text="Privacy Policy">
                          Privacy Policy
                        </span>
                      </a>
                    </div>
            ...
            <div className="col-lg-3 col-md-3 d-flex align-items-end">
              <div className="cont-info full-width">
                <div className="contact-item">
                  ...
                  <p className="underline main-color mt-3 mb-1">
                    <a style={{ color: "#f7c70c" }} href="#0">
                      91-9668200222
                    </a>
                  </p>
