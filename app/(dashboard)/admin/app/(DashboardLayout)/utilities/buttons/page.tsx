...
import BaseCard from "@/app/(dashboard)/admin/app/(DashboardLayout)/components/shared/BaseCard";
    ...
    <Grid container spacing={3}>
      ...
      >
        <BaseCard title="Text Buttons">
          <Box sx={{ "& button": { mr: 1 } }}>
            <Button variant="text" color="primary" sx={{ marginBottom: "5px" }}>
              Text
            </Button>
            ...
            <Button variant="text" color="success" sx={{ marginBottom: "5px" }}>
              Text
            </Button>
            <Button variant="text" color="warning" sx={{ marginBottom: "5px" }}>
              Text
            </Button>
          </Box>
        </BaseCard>
